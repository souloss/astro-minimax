...
astro-minimax 是一个极简、响应式、无障碍且对 SEO 友好的 Astro 博客主题。本项目基于 [AstroPaper](https://github.com/satnaing/astro-paper) 二次开发，经过多个版本的迭代，现已成为一个功能完善的独立主题。当前版本 **0.8.0** 基于 Astro v6 构建。
...
- [Astro v6](https://astro.build/) - 现代化静态站点生成器
