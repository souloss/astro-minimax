...
astro-minimax/
├── packages/
│   ├── core/      # @astro-minimax/core — 核心主题（布局、组件、样式、路由、插件）
│   ├── viz/       # @astro-minimax/viz — 可视化插件（Mermaid、Markmap 等）
...
| 包 | 版本 | 说明 |
|----|------|------|
| [`@astro-minimax/core`](packages/core/) | 0.5.0 | 核心主题：布局、组件、样式、路由注入、虚拟模块系统 |
| [`@astro-minimax/viz`](packages/viz/) | 0.5.0 | 可视化插件：Mermaid、Markmap、Rough.js、Excalidraw、Asciinema |
